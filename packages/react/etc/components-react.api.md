...
import type { AudioCaptureOptions } from '@dtelecom/livekit-client';
import type { AudioSource } from '@dtelecom/components-core';
import { CaptureOptionsBySource } from '@dtelecom/components-core';
import type { ChatMessage } from '@dtelecom/components-core';
import { ConnectionQuality } from '@dtelecom/livekit-client';
import { ConnectionState as ConnectionState_2 } from '@dtelecom/livekit-client';
import type { CreateLocalTracksOptions } from '@dtelecom/livekit-client';
import type { DataSendOptions } from '@dtelecom/components-core';
import type { GridLayoutDefinition } from '@dtelecom/components-core';
import { HTMLAttributes } from 'react';
import type { LocalAudioTrack } from '@dtelecom/livekit-client';
import { LocalParticipant } from '@dtelecom/livekit-client';
import type { LocalTrack } from '@dtelecom/livekit-client';
import { LocalTrackPublication } from '@dtelecom/livekit-client';
import type { LocalVideoTrack } from '@dtelecom/livekit-client';
import type { MediaDeviceFailure } from '@dtelecom/livekit-client';
import { Participant } from '@dtelecom/livekit-client';
import type { ParticipantClickEvent } from '@dtelecom/components-core';
import type { ParticipantEvent } from '@dtelecom/livekit-client';
import { ParticipantPermission } from '@dtelecom/livekit-client/dist/src/proto/livekit_models';
import type { PinState } from '@dtelecom/components-core';
import * as React_2 from 'react';
import type { ReceivedChatMessage } from '@dtelecom/components-core';
import type { ReceivedDataMessage } from '@dtelecom/components-core';
import { RemoteParticipant } from '@dtelecom/livekit-client';
import { Room } from '@dtelecom/livekit-client';
import type { RoomConnectOptions } from '@dtelecom/livekit-client';
import type { RoomEvent } from '@dtelecom/livekit-client';
import type { RoomOptions } from '@dtelecom/livekit-client';
import type { ScreenShareCaptureOptions } from '@dtelecom/livekit-client';
import { SetMediaDeviceOptions } from '@dtelecom/components-core';
import type { SourcesArray } from '@dtelecom/components-core';
import type { ToggleSource } from '@dtelecom/components-core';
import { Track } from '@dtelecom/livekit-client';
import { TrackPublication } from '@dtelecom/livekit-client';
import type { TrackReference } from '@dtelecom/components-core';
import type { TrackReferenceOrPlaceholder } from '@dtelecom/components-core';
import type { TrackSourceWithOptions } from '@dtelecom/components-core';
import type { VideoCaptureOptions } from '@dtelecom/livekit-client';
import type { VideoSource } from '@dtelecom/components-core';
